...
public class MainPlatform
{
  ...
  private static String PlayerOne = "Player.RandomPlayer";
  private static String PlayerTwo = "Player.HeuristicPlayer";

  private static String[] teamNames = { "Random Player", "Heuristic Player" };
  private static String[] teamClasses = { "Player.RandomPlayer",
  ...
  private static void createAndShowGUI ()
  {
    ...
    generateMap.addActionListener(new ActionListener() {
      public void actionPerformed (ActionEvent evt)
      {
        ...
        map = new WarMap(800, 300, allUnits);
        frame.add("North", map);
        frame.pack();
        ...
        Thread t = new Thread(new Runnable() {
          public void run ()
          {
            ...
            while (notwinner < 10000) {
              ...
              playerB.chooseCorridor(playerB.getStationaryMarines());
