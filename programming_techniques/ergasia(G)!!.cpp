//Thomas Christopoulos 7043
//7h ergasia 2009-2010
...
//synarthsh gia ton ypologismo tia isxyws
...
//synarthsh gia thn ekthpwsh ths katastashs olwn twn stathmwn
...
int main(){
     ...
     //etermon anakyklwsh gia ton ypologismo ths isxyws
     float power;
     for(;;){
...
//prosomoiwsh stathmwn petrelaiou
...
petrelaio::~petrelaio(){
     for(int i=0;i<n1;i++)delete name[i];
     delete name;
     delete katastash;
     delete isxy_0;
     delete wriaia_katanalwsh;
     delete syntelesths;
}
...
//prosomoiwsh stathmwn hliakhs energeias
...
hlios::~hlios(){
     for(int i=0;i<n2;i++)delete name[i];
     delete name;
     delete katastash;
     delete isxy_0;
     delete fwthnh_isxy;
